...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form action="{{route('course_update_by_id',$course->id)}}" class="mt-3" method="POST">
        @csrf

        <div class="form-group">
          <label>Course Title</label>
          <input type="text" class="form-control" name="title" value="{{$course->course_title}}">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="number" class="form-control" name="credit" value="{{$course->credit}}">
        </div>
